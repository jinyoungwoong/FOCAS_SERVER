...
public class Focas1
{
    ...
    /* [사용] cnc_rddynamic:read all dynamic data */
    [StructLayout(LayoutKind.Sequential, Pack = 4)]
    public class FAXIS
    {
        /// <summary>
    ...
    public class ODBDY_1
    {
        ...
        /// Axis number
        /// </summary>
        /// <remarks>The read axis number is returned.</remarks>
        ...
        /// <summary>
        /// Program number under execution (It is the selected program number while automatic operation stopping)
        /// </summary>
...
#endif
    /* [사용][추가] cnc_rddynamic:read all dynamic data : Max Axis = 8 */
    [StructLayout(LayoutKind.Sequential, Pack = 4)]
    public class ODBDY_1_AX8
    {
        /// <summary>
        /// Not used
        /// </summary>
        ...
        /// </summary>
        public int acts;      /* actual spindle speed */
        public FAXIS_AX8 pos = new FAXIS_AX8();
    }

    /* [사용][추가] cnc_rddynamic:read all dynamic data : Max Axis = 8 */
    [StructLayout(LayoutKind.Sequential, Pack = 4)]
    public class FAXIS_AX8
    {
        /// <summary>
        /// Absolute position of the controlled axes
        /// </summary>
    ...
    /* [사용] cnc_rdspmeter:read spindle load meter */
    [StructLayout(LayoutKind.Sequential, Pack = 4)]
    public class LOADELM
    {
        ...
        /// <summary>
        /// Spindle name (ASCII). ASCII code 'S' is stored.
        /// </summary>
        public byte name;       /* name of data */
        /// <summary>
        ...
        /// </summary>
        /// <remarks>
        /// Series 16/18/21, 16i/18i/21i, 0i, 30i, Power Mate i<br/>
        ///     The spindle number('1', '2', ...) is stored.<br/>
        /// Series 15i<br/>
        ///     The value which is defined by parameter (No. 5845, 5846) is stored.<br/>
        /// </remarks>
        ...
        /// </summary>
        /// <remarks>
        /// When the spindle switching function is available, the following ASCII code is stored.<br/>
        ///     In case of main spindle	: '1'<br/>
        ///     In case of sub spindle	: '2'<br/>
        /// When the spindle switching function is not available, NULL('\0') is stored.<br/>
        /// In case of Series 15, data is stored.But it is invalid for the spindle name.<br/>
        /// </remarks>
    ...
    /* [사용] cnc_rdspmeter:read spindle load meter and speed */
    [StructLayout(LayoutKind.Sequential, Pack = 4)]
    public class ODBSPLOAD_data
    {
        ...
        /// <summary>
        /// The LOADELM structure for spindle motor speed data.
        /// </summary>
    ...
    /* [사용] cnc_rdparar:read parameter(area specified) */
    [StructLayout(LayoutKind.Explicit)]
    ...
    /* [사용] cnc_rdparam_ext:read parameters */
    [StructLayout(LayoutKind.Sequential, Pack = 4)]
    ...
    public class IODBPRM2
    {
        ...
        /// 2 : word type<br/>
        /// 3 : 2-word type<br/>
        /// 4 : real type(Series 15i, 30i, 0i-D/F, PMi-A )<br/>
        ...
        /// </summary>
        /// <remarks>
        /// bit 0 : axis attribute<br/>
        ///     0 : without axis<br/>
        ///     1 : with axis<br/>
        /// bit 1 : spindle parameter<br/>
        ///     0 :	no spindle<br/>
        ///     1 :	spindle<br/>
        /// bit 2,..,15	: (reserve)<br/>
        /// </remarks>
        ...
        ///     0 :	with sign<br/>
        ///     1 :	without sign<br/>
        /// bit 1 :	settings input<br/>
        ///     0 :	disable<br/>
        ///     1 :	enable<br/>
        /// bit 2 :	write protection<br/>
        ///     0 :	enable<br/>
        ///     1 :	disable<br/>
        /// bit 3 :	power must be off after writing<br/>
        ///     0 :	not necessary<br/>
        ///     1 :	necessary<br/>
        /// bit 4 :	read protection<br/>
        ///     0 :	enable<br/>
        ///     1 :	disable<br/>
        /// bit 5,..,15	: (reserve)<br/>
        /// </remarks>
        ...
        ///     1 :	unit of length<br/>
        ///     2 :	unit of angle<br/>
        ///     3 :	unit of length + angle<br/>
        ///     4 :	unit of velocity<br/>
        /// bit 5,..,15	: (reserve)<br/>
        /// </remarks>
    ...
    /* [사용] cnc_sysinfo:read CNC system information */
    [StructLayout(LayoutKind.Sequential, Pack = 4)]
    public class ODBSYS
    {
        /// <summary>
        ...
        /// </summary>
        /// <remarks>
        /// This is available at Series 15i/16/18/21, 16i/18i/21i/0i, 30i/31i/32i/35i, Power Mate i, PMi-A<br/>
        /// bit 0<br/>
        ///     0 : without loader control function<br/>
        ///     1 :	with loader control function<br/>
        /// bit 1<br/>
        ///     0 :	not an i Series CNC<br/>
        ///     1 :	i Series CNC<br/>
        /// bit 2<br/>
        ///     reserved<br/>
        /// bit 3<br/>
        ///     0 : without compound machining function<br/>
        ///     1 : with compound machining function<br/>
        /// bit 4<br/>
        ///     0 : without transfer line function<br/>
        ///     1 : with transfer line function<br/>
        /// Bit5,..,Bit7<br/>
        ///     reserved<br/>
        /// Bit8~15<br/>
        ///     MODEL information<br/>
        ///     0 : MODEL information is not supported<br/>
        ///     1 : MODEL A<br/>
        ///     2 : MODEL B<br/>
        ///     3 : MODEL C<br/>
        ///     4 : MODEL D<br/>
        ///     6 : MODEL F<br/>
        ///     In Series 15i, 16/18/21, 16i/18i/21i, 0i-A/B/C, 30i-A, Power Matei, MODEL information is not supported.<br/>
        /// </remarks>
        public short addinfo;
        /// <summary>
        /// Maximum controlled axes
        /// </summary>
        /// <remarks>value itself(BINARY)</remarks>
        public short max_axis;
        /// <summary>
        /// Kind of CNC (ASCII)
        /// </summary>
        /// <remarks>
        /// Kind of CNC (ASCII)<br/>
        ///     '15' : Series 15/15i<br/>
        ///     '16' : Series 16/16i<br/>
        ///     '18' : Series 18/18i<br/>
        ///     '21' : Series 21/21i<br/>
        ...
        ///     '35' :Series 35i<br/>
        ///     ' 0' : Series 0i<br/>
        ///     'PD' : Power Mate i-D<br/>
        ///     'PH' : Power Mate i-H<br/>
        ///     'PM' : Power Motion i<br/>
        /// </remarks>
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)]
        ...
        /// </summary>
        /// <remarks>
        /// Kind of M/T (ASCII)<br/>
        ///     ' M' : Machining center<br/>
        ///     ' T' : Lathe<br/>
        ///     'MM' : M series with 2 path control<br/>
        ///     'TT' : T series with 2/3 path control<br/>
        ///     'MT' : T series with compound machining function<br/>
        ///     ' P' : Punch press<br/>
        ///     ' L' : Laser<br/>
        ///     ' W' : Wire cut<br/>
        /// </remarks>
        ...
        /// Series number (ASCII)
        /// </summary>
        /// <remarks>The character string of 4 digits is stored.</remarks>
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 4)]
        public char[] series;
        /// <summary>
        ...
        /// </summary>
        /// <remarks>The character string of 2 digits is stored. In case of 4 axes, ' 4' is set.</remarks>
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)]
        public char[] axes;
    }
...
#else
    /* [사용] cnc_statinfo:read CNC status information */
    [StructLayout(LayoutKind.Sequential, Pack = 4)]
    public class ODBST
    {
    ...
    /* [사용][추가] cnc_statinfo:read CNC status information (※ Available: Series 15/15i) */
    [StructLayout(LayoutKind.Sequential, Pack = 4)]
    public class ODBST_FS15
    {
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)]
        public short[] dummy;      /* dummy                    */
        public short aut;        /* selected automatic mode  */
    ...
    /* [사용] cnc_diagnosr:read diagnosis data(area specified) */
    [StructLayout(LayoutKind.Sequential, Pack = 4)]
    ...
    /* [사용] cnc_diagnoss:read diagnosis data */
    [StructLayout(LayoutKind.Explicit)]
    public class ODBDGN_1
    {
        ...
        /// </summary>
        /// <remarks>
        /// Upper byte:type (Series 15/15i)<br/>
        ///     0 : byte type<br/>
        ///     1 : word type<br/>
        ///     2 : 2-word type<br/>
        ///     3 : bit type(8 bit)<br/>
        ///     4 : not used<br/>
        ///     5 : real type(Series 15i)<br/>
        /// Lower byte:axis<br/>
        ///     0 : no axis<br/>
        ///     1,..,m : 1 axis(m= maximum controlled axes)<br/>
        ///     ALL_AXES : all axes(ALL_AXES= -1)<br/>
        /// </remarks>
        [FieldOffset(2)]
        public short type;      /* axis number */
        /// <summary>
        /// bit/byte diagnosis data
        /// </summary>
        [FieldOffset(4)]
        public byte cdata;     /* parameter / setting data */
        /// <summary>
    ...
    /* [사용] cnc_rdaxisname: read axis name */
    [StructLayout(LayoutKind.Sequential, Pack = 4)]
...
#if (!ONO8D)
    /* [사용] read all dynamic data */
    /// <summary>
    /// CNC 운전 시 변화하는 다양한 데이터를 한번에 읽어옵니다. (모든 축 포함인 경우, 최대축 32)
    /// </summary>
    /// <param name="FlibHndl">라이브러리 핸들을 지정하십시오.</param>
    /// <param name="axis">읽을 축 번호를 지정합니다.<br/>
    /// ALL_AXES : 모든 축에 대해(ALL_AXES : -1)<br/>
    /// 1,..,m : 축별(m : 제어축 수)</param>
    /// <param name="length">데이터 블록의 길이 지정.</param>
    /// <param name="odbdy">다양한 데이터를 포함하는 구조체에 대한 포인터.</param>
    /// <returns>성공적으로 완료되면 EW_OK가 반환되고, 그렇지 않으면 EW_OK를 제외한 모든 값이 반환됩니다.</returns>
    [DllImport("FWLIB32.dll", EntryPoint = "cnc_rddynamic")]
    public static extern short cnc_rddynamic(ushort FlibHndl, short axis, short length, [Out, MarshalAs(UnmanagedType.LPStruct)] ODBDY_1 odbdy);

    /* [사용][추가] - read all dynamic data : Max Axis = 8 */
    /// <summary>
    /// CNC 운전 시 변화하는 다양한 데이터를 한번에 읽어옵니다. (모든 축 포함인 경우, 최대축 8)
    /// </summary>
    /// <param name="FlibHndl">라이브러리 핸들을 지정하십시오.</param>
    /// <param name="axis">읽을 축 번호를 지정합니다.<br/>
    /// ALL_AXES : 모든 축에 대해(ALL_AXES : -1)<br/>
    ...
    /// <returns>성공적으로 완료되면 EW_OK가 반환되고, 그렇지 않으면 EW_OK를 제외한 모든 값이 반환됩니다.</returns>
    [DllImport("FWLIB32.dll", EntryPoint = "cnc_rddynamic")]
    public static extern short cnc_rddynamic(ushort FlibHndl, short axis, short length, [Out, MarshalAs(UnmanagedType.LPStruct)] ODBDY_1_AX8 odbdy);

    /* [원본] read all dynamic data
    [DllImport("FWLIB32.dll", EntryPoint = "cnc_rddynamic")]
    ...
    */
    ...
    /* [사용][추가] read spindle load meter : return data type = bytes */
    /// <summary>
    /// 첫 번째 스핀들부터 지정된 스핀들 번호까지 스핀들 로드 미터 데이터와 스핀들 모터 속도 데이터를 읽습니다.
    /// </summary>
    /// <param name="FlibHndl">라이브러리 핸들을 지정하십시오.</param>
    /// <param name="type">데이터 유형을 지정합니다.<br/>
    /// 0  : 스핀들 로드 미터 데이터<br/>
    /// 1  : 스핀들 모터 속도 데이터<br/>
    /// -1 : 모든 유형</param>
    /// <param name="data_num">읽을 데이터 수에 대한 포인터를 지정합니다. 이 함수는 실제로 읽은 데이터의 수를 반환합니다.</param>
    /// <param name="loadmeter">스핀들 부하 미터 데이터와 스핀들 모터 속도 데이터를 저장할 구조체의 배열에 대한 포인터를 지정합니다. 배열 수는 "*data_num"과 같아야 합니다.</param>
    /// <returns>성공적으로 완료되면 EW_OK가 반환되고, 그렇지 않으면 EW_OK를 제외한 모든 값이 반환됩니다.</returns>
    [DllImport("FWLIB32.dll", EntryPoint = "cnc_rdspmeter")]
    public static extern short cnc_rdspmeter(ushort FlibHndl, short type, ref short data_num, byte[] loadmeter);
    ...
    /* [사용][추가] read parameter(area specified) */
    /// <summary>
    /// "*s_number","*e_number","axis"로 지정된 매개변수를 읽습니다(축이 있는 매개변수만 해당). 
    /// </summary>
    /// <param name="FlibHndl">라이브러리 핸들을 지정하십시오.</param>
    /// <param name="s_number">시작 매개변수 번호를 지정합니다.</param>
    /// <param name="axis">축 번호를 지정합니다.<br/>
    /// 0       : 축을 지정하지 않음<br/>
    /// 1,..,m  : 1축 할당(m=최대 제어축)<br/>
    /// -1      : 모든 축 할당(ALL_AXES=-1)</param>
    /// <param name="e_number">끝 매개변수 번호를 지정합니다.</param>
    /// <param name="length">지정된 매개변수를 저장하기에 충분한 데이터 블록 길이를 지정하십시오</param>
    /// <param name="param">매개변수를 저장할 영역에 대한 포인터입니다</param>
    /// <returns>성공적으로 완료되면 EW_OK가 반환되고, 그렇지 않으면 EW_OK를 제외한 모든 값이 반환됩니다.</returns>
    [DllImport("FWLIB32.dll", EntryPoint = "cnc_rdparar")]
    public static extern short cnc_rdparar(ushort FlibHndl, ref short s_number, short axis, ref short e_number, ref short length, [Out, MarshalAs(UnmanagedType.LPStruct)] IODBPSD_1 param);
    ...
    public static extern short cnc_rdparam_ext(ushort FlibHndl, [In, Out, MarshalAs(UnmanagedType.LPStruct)] IODBPRMNO a, short b, [Out, MarshalAs(UnmanagedType.LPStruct)] IODBPRM c);
    /* [추가] - read parameters : return data type = bytes */
    [DllImport("FWLIB32.dll", EntryPoint = "cnc_rdparam_ext")]
    public static extern short cnc_rdparam_ext(ushort FlibHndl, int[] prm_no, short num, byte[] param);
    ...
    /* [사용] read CNC system information */
    /// <summary>
    /// CNC 시스템의 종류, 가공(M) 또는 선삭(T), CNC 시스템 소프트웨어의 시리즈 및 버전, 제어되는 축의 수와 같은 시스템 정보를 읽습니다.
    /// </summary>
    /// <param name="FlibHndl">라이브러리 핸들을 지정하십시오.</param>
    /// <param name="odbsys">CNC 시스템 정보를 포함하는 구조체에 대한 포인터.</param>
    /// <returns>성공적으로 완료되면 EW_OK가 반환되고, 그렇지 않으면 EW_OK를 제외한 모든 값이 반환됩니다.</returns>
    [DllImport("FWLIB32.dll", EntryPoint = "cnc_sysinfo")]
    public static extern short cnc_sysinfo(ushort FlibHndl, [Out, MarshalAs(UnmanagedType.LPStruct)] ODBSYS odbsys);

    /* [원본] read CNC system information
    [DllImport("FWLIB32.dll", EntryPoint = "cnc_sysinfo")]
    public static extern short cnc_sysinfo(ushort FlibHndl, [Out, MarshalAs(UnmanagedType.LPStruct)] ODBSYS a);
    */

    /* [사용] read CNC status information */
    /// <summary>
    /// CNC의 상태 정보를 읽습니다.
    /// </summary>
    /// <param name="FlibHndl">라이브러리 핸들을 지정하십시오.</param>
    /// <param name="odbst">CNC의 상태 정보를 포함하는 구조체에 대한 포인터</param>
    /// <returns>성공적으로 완료되면 EW_OK가 반환되고, 그렇지 않으면 EW_OK를 제외한 모든 값이 반환됩니다.</returns>
    [DllImport("FWLIB32.dll", EntryPoint = "cnc_statinfo")]
    public static extern short cnc_statinfo(ushort FlibHndl, [Out, MarshalAs(UnmanagedType.LPStruct)] ODBST odbst);

    /* [사용][추가] read CNC status information (※ Available: Series 15/15i) */
    /// <summary>
    /// CNC의 상태 정보를 읽습니다. (※ Available: Series 15/15i)
    /// </summary>
    /// <param name="FlibHndl">라이브러리 핸들을 지정하십시오.</param>
    /// <param name="odbst">CNC의 상태 정보를 포함하는 구조체에 대한 포인터</param>
    /// <returns>성공적으로 완료되면 EW_OK가 반환되고, 그렇지 않으면 EW_OK를 제외한 모든 값이 반환됩니다.</returns>
    [DllImport("FWLIB32.dll", EntryPoint = "cnc_statinfo")]
    public static extern short cnc_statinfo(ushort FlibHndl, [Out, MarshalAs(UnmanagedType.LPStruct)] ODBST_FS15 odbst);

    /* [원본] read CNC status information
    [DllImport("FWLIB32.dll", EntryPoint = "cnc_statinfo")]
    ...
    */
    ...
    /* [사용] read diagnosis data */
    /// <summary>
    /// 지정된 진단을 읽습니다(축이 있는 진단에만 해당). (1축인 경우)
    /// </summary>
    /// <param name="FlibHndl">라이브러리 핸들을 지정하십시오.</param>
    /// <param name="number">진단 번호를 지정합니다. cnc_rddiagnum 함수와 cnc_rddiaginfo 함수 로 얻을 수 있습니다 .</param>
    /// <param name="axis">축 번호를 지정합니다.</param>
    /// <param name="length">데이터 블록 길이.</param>
    /// <param name="diag">진단 데이터를 포함하는 구조체에 대한 포인터.</param>
    /// <returns>성공적으로 완료되면 EW_OK가 반환되고, 그렇지 않으면 EW_OK를 제외한 모든 값이 반환됩니다.</returns>
    [DllImport("FWLIB32.dll", EntryPoint = "cnc_diagnoss")]
    public static extern short cnc_diagnoss(ushort FlibHndl, short number, short axis, short length, [Out, MarshalAs(UnmanagedType.LPStruct)] ODBDGN_1 diag);

    /* [원본] read diagnosis data
    [DllImport("FWLIB32.dll", EntryPoint = "cnc_diagnoss")]
    ...
    */
    ...
    /// <summary>
    /// 지정된 실제 진단을 읽습니다(축이 있는 진단에만 해당). (1축인 경우, 실제 진단 데이터)
    /// </summary>
    /// <param name="FlibHndl">라이브러리 핸들을 지정하십시오.</param>
    /// <param name="number">진단 번호를 지정합니다. cnc_rddiagnum 함수와 cnc_rddiaginfo 함수 로 얻을 수 있습니다 .</param>
    /// <param name="axis">축 번호를 지정합니다.</param>
    ...
    /// <returns>성공적으로 완료되면 EW_OK가 반환되고, 그렇지 않으면 EW_OK를 제외한 모든 값이 반환됩니다.</returns>
    [DllImport("FWLIB32.dll", EntryPoint = "cnc_diagnoss")]
    public static extern short cnc_diagnoss(ushort FlibHndl, short number, short axis, short length, [Out, MarshalAs(UnmanagedType.LPStruct)] ODBDGN_2 diag);
    ...
    */
    ...
    /* [사용] free library handle */
    /// <summary>
    /// 데이터 창 라이브러리에서 사용된 라이브러리 핸들을 해제합니다.
    /// </summary>
    /// <param name="FlibHndl">라이브러리 핸들</param>
    /// <returns>성공적으로 완료되면 EW_OK가 반환되고, 그렇지 않으면 EW_OK를 제외한 모든 값이 반환됩니다.</returns>
    [DllImport("FWLIB32.dll", EntryPoint = "cnc_freelibhndl")]
    public static extern short cnc_freelibhndl(ushort FlibHndl);

    /* [원본] free library handle
    [DllImport("FWLIB32.dll", EntryPoint = "cnc_freelibhndl")]
    public static extern short cnc_freelibhndl(ushort FlibHndl);
    */
    ...
    public static extern short cnc_rdaxisname(ushort FlibHndl, ref short a, [Out, MarshalAs(UnmanagedType.LPStruct)] ODBAXISNAME b);

    /* [사용][추가] - read axis name : return data type = bytes */
    /// <summary>
    /// 첫 번째 축부터 지정된 축 번호까지 축 이름을 읽습니다.
    /// </summary>
    /// <param name="FlibHndl">라이브러리 핸들을 지정하십시오.</param>
    /// <param name="data_num">읽을 데이터 수에 대한 포인터를 지정합니다. 이 함수는 실제로 읽은 데이터의 수를 반환합니다.</param>
    /// <param name="axisname">축 이름을 저장할 바이트 배열에 대한 포인터를 지정합니다. 배열 수는 "*data_num"과 같아야 합니다.</param>
    /// <returns>성공적으로 완료되면 EW_OK가 반환되고, 그렇지 않으면 EW_OK를 제외한 모든 값이 반환됩니다.</returns>
    [DllImport("FWLIB32.dll", EntryPoint = "cnc_rdaxisname")]
    public static extern short cnc_rdaxisname(ushort FlibHndl, ref short data_num, byte[] axisname);
    ...
    /* [사용] allocate library handle 3 */
    /// <summary>
    /// 라이브러리 핸들을 할당하고 지정된 IP 주소 또는 호스트 이름을 가진 CNC에 연결합니다.
    /// </summary>
    /// <param name="ipaddr">연결할 CNC의 IP 주소 또는 호스트 이름의 문자열을 지정합니다.</param>
    /// <param name="port">Ethernet 기능의 포트 번호를 지정합니다.</param>
    /// <param name="timeout">시간 초과에 대한 초를 지정합니다.
    /// 0을 지정하면 시간 초과 프로세스가 무시되고 라이브러리 함수는 무한대로 기다립니다.<br/>
    /// 최적의 타임아웃 값은 시스템에 따라 다릅니다.
    /// 예를 들어, 고속 네트워크 시스템의 경우 타임아웃은 10초면 충분합니다. 그러나 저속 전화선으로 중계하는 경우에는 60초 이상이 타임아웃에 좋습니다.
    /// 따라서 통신 시간을 측정한 후 타임아웃 값을 지정해야 합니다.</param>
    /// <param name="FlibHndl">라이브러리 핸들을 포함하는 변수에 대한 포인터를 지정하십시오.</param>
    /// <returns>성공적으로 완료되면 EW_OK가 반환되고, 그렇지 않으면 EW_OK를 제외한 모든 값이 반환됩니다.</returns>
    [DllImport("FWLIB32.dll", EntryPoint = "cnc_allclibhndl3")]
    public static extern short cnc_allclibhndl3([In, MarshalAs(UnmanagedType.AsAny)] object ipaddr, ushort port, int timeout, out ushort FlibHndl);

    /* [원본] allocate library handle 3
    [DllImport("FWLIB32.dll", EntryPoint = "cnc_allclibhndl3")]
