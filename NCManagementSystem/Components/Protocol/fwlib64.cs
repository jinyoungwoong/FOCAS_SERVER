...
/*-------------*/
    ...
    {
        public ulong size;           /* フ?イルサイズ(byte) */
        public byte min;           /* ?イ?ス?ンプ(分) */
        public byte hour;          /* ?イ?ス?ンプ(時) */
        public byte day;           /* ?イ?ス?ンプ(日) */
        public byte month;         /* ?イ?ス?ンプ(月) */
        public ushort year;          /* ?イ?ス?ンプ(年) */
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)]
